  ...
  module.exports = {
    ...
    tabulate: function(req, res) {
      ...
      return Chocolate.find(function(err, votes) {
        var allVotes, choice, collectVotes, findVotesToRemove, followingRounds, next, reallocateVotes, roundStatus, secondRound, tabulatedObjectToRender, _i, _j, _len, _len1, _ref, _ref1;
        if (err) {
