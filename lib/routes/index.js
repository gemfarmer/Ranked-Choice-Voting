  ...
  module.exports = {
    ...
    tabulate: function(req, res) {
      ...
      return Chocolate.find(function(err, votes) {
        var choice, collectVotes, findVotesToRemove, followingRounds, mappedVotes, next, reallocatedVotes, roundStatus, secondRound, tabulatedObjectToRender, _i, _j, _len, _len1, _ref, _ref1;
        if (err) {
          ...
          reallocatedVotes = function(AllVotes, firstRoundLosers, firstRoundWinners) {
            ...
            addVotes = function(firstRoundWinners, voteCount) {
              var choice, totalVotes, vote, _i, _j, _k, _len, _len1, _len2;
              totalVotes = 0;
          ...
          if (next) {
            roundStatus++;
            secondRound();
            _ref1 = findVotesToRemove(collectVotes(secondRound())).remainingChoices;
