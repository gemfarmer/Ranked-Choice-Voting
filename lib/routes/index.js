  ...
  module.exports = {
    ...
    tabulate: function(req, res) {
      ...
      return Chocolate.find(function(err, votes) {
        var collectVotes, findVotesToRemove, firstRoundLosers, firstRoundWinners, mappedVotes, realallocatedVotes, reallocated, tabulatedObjectToRender;
        if (err) {
          ...
          realallocatedVotes = function(AllVotes, firstRoundLosers, firstRoundWinners) {
